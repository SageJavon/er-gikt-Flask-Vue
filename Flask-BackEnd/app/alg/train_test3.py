...
output_file.close()
torch.save(model, f=f'model-30/result.pt')
np.savetxt(f'chart_data_30/result_all.txt', y_label_all)
np.savetxt(f'chart_data_30/result_aver.txt', y_label_aver)
